...
system.cpu_voltage_domain.voltage = '0.9V'  # Lower voltage with lower frequency
...
print("\n[Phase 3] Reducing voltage to 0.7V for final phase...")
system.cpu_clk_domain.clock = '300MHz'
system.cpu_voltage_domain.voltage = '0.7V'
